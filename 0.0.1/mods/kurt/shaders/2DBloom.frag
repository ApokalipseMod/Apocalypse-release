// Automatically converted with https://github.com/TheLeerName/ShadertoyToFlixel Source: https://www.shadertoy.com/view/XtsSzr
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
	...
	fragColor = vec4(origClr,texture(iChannel0, uv).a);
}
